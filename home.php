...
<html lang="en">
    ...
    <body >
        ...
        <section class="second-section">
            <div class=box-two>
                <div class=text>
                We design and present our products to your needs and wishes. Whether events, exhibitions, tastings and the like, we have a broad portfolio with which we can convince.
                </div>
                <div class="icons">
        ...
        <section class="fifth-section">
            <div class="middle-blue-column-5"></div>
            <div class="title">The best spirits, Wherever you might need them.</div>
        ...
        <section class="sixth-section">
            <div class="middle-blue-column-6"></div>
            <div class="title">
            ...
            <div class="things">
                ...
                <div><img src="Img/gin-moment.png" alt="">
                    <div class="text">GIN MOMENT</div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
                    </svg>
                </div>
                
                <div><img src="Img/connoisseur.png" alt="">
                    <div class="text">CONNOISSEUR</div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
                    </svg>
                </div>
